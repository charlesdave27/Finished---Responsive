...
export default function Navigation() {
  ...
  return (
    <nav className="text-primary-50 m-auto flex max-w-[90rem] justify-between px-24 text-lg/8 font-light max-xl:px-16 max-xl:text-base/loose max-lg:px-8 max-md:px-6">
      ...
      >
        <Logo
          className="stroke-primary-500 h-25 max-md:h-5"
          alt="roller space icon"
          width={100}
        />
       <p className="text-4xl font-extrabold tracking-tight max-xl:text-3xl max-md:text-2xl max-md:tracking-tight">
        ROLLERSPACE
      </p>
